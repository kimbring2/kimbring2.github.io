...
# Real soccer test
While trarning the simulation, the actual environment is constructed for using the trained model. I use various basic examples of Jetbot to check the operation of the robot in this environment.

<img src="/assets/jetbot_real_soccer.jpg.png" width="800">
