...
The video is recorded after changing four Dynamixel operating mode to wheel and setting speed value to 30. At next step, we should check how to set the speed value with Python code using Dynamixel SDK.
...
[![Gazebo wheel test](https://img.youtube.com/vi/r4q-eAadR_o/hqdefault.jpg)](https://youtu.be/r4q-eAadR_o "Jetbot Soccer Play - Click to Watch!")
<strong>Click to Watch!</strong>

[![Gazebo ball holding test](https://img.youtube.com/vi/7Z_sYcTUTlQ/hqdefault.jpg)](https://youtu.be/7Z_sYcTUTlQ "Jetbot Soccer Play - Click to Watch!")
<strong>Click to Watch!</strong>

Gazebo similarly tested the operation of each part via the 'rostopic pub' command. When the robot catches and holds the ball, it appears that the friction and inertial is closely related, and it is necessary to set accurate physical parameters.
...
After setting the appropriate physical parameters, robot can kick a ball which taken using the roller using solenoid stick.
