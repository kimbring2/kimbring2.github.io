...
For the part for grabiing the soccer ball, I use a part of engraving roller. The core of the roller is madebed by 3D printer and connected to a DC motor which is included in origin Jetbot.
...
After designing the hardware of the robot, I generate a 3D model for trarning it in Gazebo simulation. After that, the rotation of the wheel is first confirmed using RViz in the same manner like a original Jetbot simulation.
