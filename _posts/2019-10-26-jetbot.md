...
Thus, I reconfirm the part that detects the soccer ball. When the minimum distance for detection is confirmed while changing the distance, it is quite short. I think the reason of that problem is angle of Jetbot's camera which is slightly facing the floor not straight ahead.
