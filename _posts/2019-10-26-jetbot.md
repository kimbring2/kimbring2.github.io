...
Due to the late readiness of the soccer ball catching and car parts, I decide to first create the control code for the assembled omniwheel. The bodies produced for the test are assembled together and power is supplied to Jetson Nano and Dynamixel.
