...
17. [Real Jetbot test](#real_jetbot_test)
    ...
    4. [Controlling wheel of Jetbot Soccer version](#control_wheel_jetbot_soccer)
...
<a name="control_wheel_jetbot_soccer"></a>
...
These files must be built using 'catkin_make' first, usually like a ROS project. Then run 'roscore' and then run that file with 'python jetbot_soccer_motors.py'. You can then use the rostopic list command to see the topic for each wheel published.

<img src="/assets/jetbot_soccer_wheel_topic_1.png" width="800">
...
<img src="/assets/jetbot_soccer_proto_1.png" width="450">
