...
The most basic action of Jetbot is the speed of both wheels. However, since this speed value is a continuos value, the range is too wide for direct use. Thus, I combine this value and turned it into the five most used actions in soccer.
...
kick_action = [100, 100]
robot_action_list = [forward_action, left_action, right_action, bacward_action, kick_action]
```

Then, I select the generated discrete type action as random and confirm the action of Jetbot.

```
robot1_action_index = random.randint(0,4)
robot2_action_index = random.randint(0,4)
