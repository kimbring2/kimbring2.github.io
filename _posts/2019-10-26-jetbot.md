...
# Reference
[Jetbot SDF file, ROS](https://github.com/dusty-nv/jetbot_ros)
[Gazebo parameter](https://github.com/CentroEPiaggio/irobotcreate2ros)
[URDF file usage in Gazebo](http://gazebosim.org/tutorials/?tut=ros_urdf)
[Object dection using cvlib](https://towardsdatascience.com/object-detection-with-less-than-10-lines-of-code-using-python-2d28eebc5b11)
[Soccer field, ball model](https://github.com/RoboCup-MSL/MSL-Simulator)
[Reinforcement Learnig model](https://medium.com/emergent-future/simple-reinforcement-learning-with-tensorflow-part-6-partial-observability-and-deep-recurrent-q-68463e9aeefc)
