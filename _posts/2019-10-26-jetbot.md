...
19. [Real soccer test](#real_soccer_test)
...
# Jetbot Reinforcement Learning test 1
...
# Jetbot Reinforcement Learning test 2
...
# Jetbot Reinforcement Learning test 3
...
<a name="real_soccer_test"></a>
# Real soccer test
While trarning the simulation, the actual environment is constructed for using the trained model. I use various basic examples of Jetbot to check the operation of the robot in this environment. Unprotected 18560 battery can not be imported in South Korea. However, I found one battery seller in the secondhand market and ordered!

<img src="/assets/jetbot_real_soccer.jpg" width="410"> <img src="/assets/jetbot_real_soccer_1.png" width="400">

While creating the actual environment directly, I am able to discover other points between simulation and actual. The biggest one is that Jetbot should not collide with each other because the camera is exposed to the outside. It seems that camera will be broken at the time of collision.
