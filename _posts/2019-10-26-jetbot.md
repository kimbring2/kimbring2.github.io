...
# Reference
https://github.com/dusty-nv/jetbot_ros : Jetbot SDF file, ROS
...
However, the 18650 battery installed on Jetbot can not be purchased in Korea local shop. That's why I try to buy from an overseas online shop. It looks difficult importing battery from another country because of customs clearance. Thus, I can not test the Jetbot using the battery.
