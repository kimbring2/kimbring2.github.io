...
17. [First Jetbot Reinforcement Learning Result](#rl_result_1)
18. [Second Jetbot Reinforcement Learning Result](#rl_result_2)
...
# First Jetbot Reinforcement Learning Result
...
# Second Jetbot Reinforcement Learning test
...
However, Jetbot do not take a soccer ball exactly in the middle of the camera. Thus, I check a the conditions that gave reward and find it is too wide and decide to narrow the scope.
