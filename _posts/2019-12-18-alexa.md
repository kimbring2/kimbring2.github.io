...
There is official manual for inplementing Alexa in Raspberry Pi [Set up Raspberry Pi]https://developer.amazon.com/en-US/docs/alexa/alexa-voice-service/set-up-raspberry-pi.html).
