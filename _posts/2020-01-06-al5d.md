...
2. [PRELIMINARIES](#preliminaries)
    ...
    4. [Object detection and segmentation](#object_detection_segmentation)
    5. [Depth Estimation](#depth_estimation)
    6. [Model-Based Deep Reinforcement Learning](#model_based_rl)
...
<a name="object_detection_segmentation"></a>
...
After trarning a single image, I apply Mask R-CNN to the image being streamed from webcam.

[![Mask R-CNN test](http://i3.ytimg.com/vi/Tvx_hU5f_lY/hqdefault.jpg)](https://youtu.be/Tvx_hU5f_lY "Jetbot Soccer Play - Click to Watch!")
...
[![Mask R-CNN test](http://i3.ytimg.com/vi/Tvx_hU5f_lY/hqdefault.jpg)](https://youtu.be/Tvx_hU5f_lY "AL5D Play Tower game - Click to Watch!")
<strong>Click to Watch!</strong>

<a name="depth_estimation"></a>
## Depth Estimation
The robot arm must use a Mask R-CNN to determine the 2D position of the block, and determine how far apart the block is using Depth Estimation method.

<img src="/assets/al5d/monodepth_example_1.gif" width="600">

Since the 2D information and the depth information of the object are used together as inputs in the Neural Network of robot agent, the output of Mask R-CNN and Monocular Depth Estimation must be displayed on same screen.
[![Depth Estimation with Mask R-CNN](https://img.youtube.com/vi/MkQFMo9xBfM/hqdefault.jpg)](https://youtu.be/MkQFMo9xBfM "AL5D Play Tower game - Click to Watch!")
<strong>Click to Watch!</strong>
